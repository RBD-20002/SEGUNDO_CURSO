...
public class BD4 {
    ...
    public void crearBD(){
        ...
        try(Statement st = connectionUni.createStatement()){
            ...
            st.executeUpdate("CREATE TABLE objetos.inscripciones(inscripcion_id serial, estudiante_id integer, curso_id integer, PRIMARY KEY (inscripcion_id), FOREIGN KEY (estudiante_id) REFERENCES objetos.estudiantes(estudiante_id), FOREIGN KEY (curso_id) REFERENCES objetos.cursos(curso_id))");
            st.executeUpdate("CREATE TABLE objetos.profesores(profesor_id serial, datos_personales objetos.persona, profesor_info objetos.profesor, curso_id integer, PRIMARY KEY (profesor_id), FOREIGN KEY (curso_id) REFERENCES objetos.cursos(curso_id))");
